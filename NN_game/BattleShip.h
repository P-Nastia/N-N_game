...
{
protected:
	string whose;//чи поле гравця чи суперника
	...
	vector<Texture> shipsTextures;//текстури для картинок кораблів
	vector<Sprite> shipsSprite;//картинки кораблів опонента, по яких орієнтуються скільки залишилося збити
	bool myTurn;//чий хід
	...
	int countForShips[4];//масив з кількості збитих кораблів
	gameText countForShipsText[4] = { {"0 x ","Fonts/LeagueSpartan-Bold.ttf"},{"0 x ","Fonts/LeagueSpartan-Bold.ttf"},
		{"0 x ","Fonts/LeagueSpartan-Bold.ttf" },{"0 x ","Fonts/LeagueSpartan-Bold.ttf"} };//масив для виводу тексту з кількості збитих кораблів
	...
	void loadField();//завантажує поле в fullField
	...
	void changeCounter(int shotInto);//змінити кількість збитих кораблів
public:
